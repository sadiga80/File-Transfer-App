package com.appsan.santhoshadigau.transf_it.utils;
...
public class HotspotControl {
    ...
    /**
     * Not necessary to {@link HotspotControl} functionality but added here to help {@link TRANSFItActivity} with port number to display connection URL
     */
     ...
     * @param port Port number assigned to {@link com.tml.sharethem.sender.SHAREthemServer}, not used anywhere in {@link HotspotControl} but helps {@link TRANSFItActivity} to display port info
