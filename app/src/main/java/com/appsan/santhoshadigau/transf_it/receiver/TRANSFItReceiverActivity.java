...
package com.appsan.santhoshadigau.transf_it.receiver;
...
import static com.appsan.santhoshadigau.transf_it.utils.WifiUtils.connectToOpenHotspot;


public class TRANSFItReceiverActivity extends AppCompatActivity {
...
//                R.anim.push_right_in, R.anim.push_right_out);
    ...
    static class WifiTasksHandler extends Handler {
        ...
        private WeakReference<TRANSFItReceiverActivity> mActivity;

        WifiTasksHandler(TRANSFItReceiverActivity activity) {
            mActivity = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final TRANSFItReceiverActivity activity = mActivity.get();
            if (null == activity)
                return;
            switch (msg.what) {
